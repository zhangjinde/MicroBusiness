...
<html>
	...
	<body>
		<table id="dg" title="已取消订单" class="easyui-datagrid" width="100%" style="height:570px" url="<%=path %>/order.do?method=getOrderList&orderType=P" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
			<thead>
				<tr>
