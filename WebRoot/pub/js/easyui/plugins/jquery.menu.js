		...
		function _6(_a) {
			...
			if (_a.hasClass("menu-content")) {
				...
				_a.children("div").each(function() {
					var _c = $(this);
					var _d = $.extend({}, $.parser.parseOptions(this, ["name",
											"iconCls", "href", {
												separator : "boolean"
											}]), {
	...
	function _38(_39, _3a) {
		...
		if (_3a.parent) {
			if (!_3a.parent.submenu) {
				var _3c = $("<div class=\"menu\"><div class=\"menu-line\"></div></div>")
						.appendTo("body");
				_3c.hide();
	...
	$.fn.menu.methods = {
		...
		setIcon : function(jq, _49) {
			return jq.each(function() {
						...
						if (_4a.iconCls) {
							$(_4a.target).children("div.menu-icon")
									.removeClass(_4a.iconCls)
									.addClass(_49.iconCls);
						} else {
							$("<div class=\"menu-icon\"></div>")
									.addClass(_49.iconCls).appendTo(_49.target);
						}
					});
		},
