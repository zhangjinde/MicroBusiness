		...
		if (pp.panel("options").split) {
			...
			_23.resizable($.extend({}, {
				...
				onStartResize : function(e) {
					...
					if (dir == "north") {
						pos.top = parseInt(_23.css("top")) + _23.outerHeight()
								- _25.height();
				...
				onResize : function(e) {
					if (dir == "north" || dir == "south") {
						...
						_29.css("top", e.pageY - $(_1c).offset().top
										- _29.height() / 2);
					} else {
						var _29 = $(">div.layout-split-proxy-h", _1c);
						_29.css("left", e.pageX - $(_1c).offset().left
										- _29.width() / 2);
					}
					return false;
				},
			...
			if (_31 == "east") {
				...
				if (_31 == "west") {
					...
					if (_31 == "north") {
						...
						_33.east.add(_33.west).add(_33.expandEast)
								.add(_33.expandWest).panel("resize", {
											top : 28 - 1,
											height : hh
										});
						return {
