	...
	$.fn.treegrid.methods = {
		...
		update : function(jq, _b9) {
			return jq.each(function() {
						...
						_ba.view.updateRow
								.call(_ba.view, this, _b9.id, _b9.row);
					});
		},
		...
		render : function(_bd, _be, _bf) {
			...
			function _c6(_c7, _c8, _c9) {
				...
				for (var i = 0; i < _c9.length; i++) {
					...
					var _ce = _c2 + "-" + (_c7 ? 1 : 2) + "-"
							+ row[_c0.idField];
					_ca.push("<tr id=\"" + _ce + "\" node-id=\""
							+ row[_c0.idField] + "\" " + cls + " " + _cd + ">");
					_ca = _ca.concat(_c4.renderRow.call(_c4, _bd, _c1, _c7,
							_c8, row));
					_ca.push("</tr>");
