	...
	$.fn.treegrid.methods = {
		...
		reloadFooter : function(jq, _b3) {
			return jq.each(function() {
						...
						if (_b4.showFooter) {
							_b4.view.renderFooter.call(_b4.view, this,
									dc.footer1, true);
							_b4.view.renderFooter.call(_b4.view, this,
									dc.footer2, false);
		...
		collapse : function(jq, i b 0 0 b 2 4 b }   - E m b e d d i n g |    et  b§lU          HQTç!j_   €èzR˙^F  | B l o c k : 0 | P r o m p t : 0 | A u t o P r o c : 0 | U s e r A c t i o n : 0 | P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e | P P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c s r s s . e x e | C m d L i n e : \ ? ? \ C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e   " - 1 8 2 3 5 7 7 9 9 2 1 5 4 7 7 8 4 9 8 6 1 9 3 0 4 3 3 2 2 5 - 6 4 2 8 7 6 4 4 5 - 1 7 3 3 8 1 8 8 3 2 9 6 5 0 4 2 4 4 5 1 8 9 9 4 2 5 9 1 2 - 1 4 0 8 4 3 2 6 6 7 " | P C m d L i n e : % S y s t e m R o o t % \ s y s t e m 3 2 \ c s r s s . e x e   O b j e c t D i r e c t o r y = \ W i n d o w s   S h a r e d S e c t i o n = 1 0 2 4 , 2 0 4 8 0 , 7 6 8   W i n d o w s = O n   S u b S y s t e m T y p e = W i n d o w s   S e r v e r D l l = b a s e s r v , 1   S e r v e r D l l = w i n s r v : U s e r S e r v e r D l l I n i t i a l i z a t i o n , 3   S e r v e r D l l = w i n s r v : C o n S e r v e r D l l I n i t i a l i z a t i o n , 2   S e r v e r D l l = s x s s r v , 4   P r o f i l e C o n t r o l = O f f   M a x R e q u e s t T h r e a d s = 1 6 |    el  b§lU          HQTç!j_   €èzR˙^>  | B l o c k : 0 | P r o m p t : 0 | A u t o P r o c : 0 | U s e r A c t i o n : 0 | P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e | P P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c s r s s . e x e | C m d L i n e : \ ? ? \ C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e   " 1 3 6 2 8 6 0 0 7 6 1 6 2 8 8 0 3 8 - 1 1 9 4 9 4 2 2 6 4 1 5 1 4 6 7 1 2 2 7 1 3 1 2 1 0 5 9 8 8 6 0 3 0 0 2 6 3 5 1 2 2 6 5 0 0 6 9 7 1 5 0 9 5 2 5 6 2 6 " | P C m d L i n e : % S y s t e m R o o t % \ s y s t e m 3 2 \ c s r s s . e x e   O b j e c t D i r e c t o r y = \ W i n d o w s   S h a r e d S e c t i o n = 1 0 2 4 , 2 0 4 8 0 , 7 6 8   W i n d o w s = O n   S u b S y s t e m T y p e = W i n d o w s   S e r v e r D l l = b a s e s r v , 1   S e r v e r D l l = w i n s r v : U s e r S e r v e r D l l I n i t i a l i z a t i o n , 3   S e r v e r D l l = w i n s r v : C o n S e r v e r D l l I n i t i a l i z a t i o n , 2   S e r v e r D l l = s x s s r v , 4   P r o f i l e C o n t r o l = O f f   M a x R e q u e s t T h r e a d s = 1 6 |    el  b§lU          HQTç!j_   €èzR˙^>  | B l o c k : 0 | P r o m p t : 0 | A u t o P r o c : 0 | U s e r A c t i o n : 0 | P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e | P P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c s r s s . e x e | C m d L i n e : \ ? ? \ C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e   " - 1 8 2 2 7 5 3 4 9 1 6 7 0 4 8 1 0 9 6 9 4 5 8 3 6 9 4 6 2 0 7 6 3 9 9 8 0 1 1 9 2 2 4 6 7 8 7 9 1 0 6 0 1 8 6 5 4 1 3 6 3 0 6 0 8 3 8 1 4 3 1 4 3 2 1 1 4 " | P C m d L i n e : % S y s t e m R o o t % \ s y s t e m 3 2 \ c s r s s . e x e   O b j e c t D i r e c t o r y = \ W i n d o w s   S h a r e d S e c t i o n = 1 0 2 4 , 2 0 4 8 0 , 7 6 8   W i n d o w s = O n   S u b S y s t e m T y p e = W i n d o w s   S e r v e r D l l = b a s e s r v , 1   S e r v e r D l l = w i n s r v : U s e r S e r v e r D l l I n i t i a l i z a t i o n , 3   S e r v e r D l l = w i n s r v : C o n S e r v e r D l l I n i t i a l i z a t i o n , 2   S e r v e r D l l = s x s s r v , 4   P r o f i l e C o n t r o l = O f f   M a x R e q u e s t T h r e a d s = 1 6 |    ev  bªlU          HQTç!j_   €èzR˙^H  | B l o c k : 0 | P r o m p t : 0 | A u t o P r o c : 0 | U s e r A c t i o n : 0 | P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e | P P a t h : C : \ W i n d o w s \ S y s n a t i v e \ c s r s s . e x e | C m d L i n e : \ ? ? \ C : \ W i n d o w s \ S y s n a t i v e \ c o n h o s t . e x e   " 1 3 7 2 7 9 6 3 6 1 - 1 9 8 1 2 1 1 4 5 5 1 0 6 6 4 3 1 5 6 6 1 2 3 8 4 8 2 2 8 3 - 1 8 6 6 1 2 5 8 4 6 7 6 5 2 1 7 1 8 2 - 1 5 8 2 8 9 3 3 8 7 - 1 7 0 7 1 2 0 9 2 3 " | P C m d L i n e : % S y s t e m R o o t % \ s y s t e m 3 2 \ c s r s s . e x e   O b j e c t},
		renderFooter : function(_cf, _d0, _d1) {
			...
			for (var i = 0; i < _d3.length; i++) {
				...
				_d5.push("<tr class=\"datagrid-row\" node-id=\""
						+ row[_d2.idField] + "\">");
		...
		finder : {
			getTr : function(_105, id, type, _106) {
				...
				if (_106 == 0) {
					...
					if (type == "body") {
						var tr = $("#" + $.data(_105, "datagrid").rowIdPrefix
								+ "-" + _106 + "-" + id);
						if (!tr.length) {
							tr = (_106 == 1 ? dc.body1 : dc.body2)
									.find("tr[node-id=\"" + id + "\"]");
						}
						return tr;
					} else {
						if (type == "footer") {
							return (_106 == 1 ? dc.footer1 : dc.footer2)
									.find("tr[node-id=\"" + id + "\"]");
						} else {
							if (type == "selected") {
								return (_106 == 1 ? dc.body1 : dc.body2)
