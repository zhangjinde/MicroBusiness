		...
		$(_3).datagrid($.extend({}, _5, {
					...
					onClickRow : function(_6, _7) {
						...
						if (_5.editIndex != _6 && _7.editor) {
							var _8 = $(this).datagrid("getColumnOption",
									"value");
							_8.editor = _7.editor;
							_a(_1);
							$(this).datagrid("beginEdit", _6);
							$(this).datagrid("getEditors", _6)[0].target
									.focus();
							_5.editIndex = _6;
						}
	...
	var _14 = $.extend({}, $.fn.datagrid.defaults.view, {
		...
		renderGroup : function(_1a, _1b, _1c, _1d) {
			...
			for (var j = 0; j < _1c.rows.length; j++) {
				var css = _1f.rowStyler ? _1f.rowStyler.call(_1a, _22,
						_1c.rows[j]) : "";
				var _23 = "";
				var _24 = "";
				...
				_21.push("<tr id=\"" + _26 + "\" datagrid-row-index=\"" + _22
						+ "\" " + cls + " " + _25 + ">");
				_21.push(this.renderRow.call(this, _1a, _20, _1d, _22,
						_1c.rows[j]));
				_21.push("</tr>");
				_22++;
			}
		...
		bindEvents : function(_27) {
			...
			_29.unbind("click").bind("click", function(e) {
				...
				if (_2b.length) {
					var _2c = _2b.closest("div.datagrid-group")
							.attr("group-index");
	...
	$.extend($.fn.datagrid.methods, {
				expandGroup : function(jq, _3a) {
					return jq.each(function() {
								...
								var _3c = _3b.find(_3a != undefined
								...
								if (_3d.hasClass("datagrid-row-expand")) {
									_3d.removeClass("datagrid-row-expand")
				...
				collapseGroup : function(jq, _3e) {
					return jq.each(function() {
								...
								if (_41.hasClass("datagrid-row-collapse")) {
									_41.removeClass("datagrid-row-collapse")
