...
(function($) {
	...
	var _1e9 = {
		...
		onAfterRender : function(_222) {
			...
			if (opts.showFooter) {
				var _223 = $(_222).datagrid("getPanel")
		...
		finder : {
			getTr : function(_229, _22a, type, _22b) {
				...
				if (_22b == 0) {
					...
					if (type == "body") {
						var tr = $("#" + _22c.rowIdPrefix + "-" + _22b + "-"
								+ _22a);
						if (!tr.length) {
							tr = (_22b == 1 ? dc.body1 : dc.body2)
						...
						if (type == "footer") {
							return (_22b == 1 ? dc.footer1 : dc.footer2)
									.find(">table>tbody>tr[datagrid-row-index="
											+ _22a + "]");
						} else {
							if (type == "selected") {
								return (_22b == 1 ? dc.body1 : dc.body2)
