...
(function($) {
	...
	function _11(_12) {
		...
		function _1b(_26, _27) {
			...
			_28.removeClass("tree-dnd-yes tree-dnd-no").addClass(_27
					? "tree-dnd-yes"
					: "tree-dnd-no");
		};
	...
	function _4b(_4c, ul, _4d, _4e) {
		...
		if (!_4e) {
			...
			if (_52) {
				_52.children
						? _52.children = _52.children.concat(_4d)
						: _52.children = _4d;
			} else {
	...
	function _5a(_5b, ul, _5c) {
		...
		var _62 = $(ul).children("li:last").children("div.tree-node")
				.addClass("tree-node-last");
		_62.children("span.tree-join").removeClass("tree-join")
	...
	function _9e(_9f, _a0) {
		...
		if (_a1) {
			if (!_a1.children || !_a1.children.length) {
				var _a2 = $(_a1.target);
				_a2.find(".tree-icon").removeClass("tree-folder")
						.addClass("tree-file");
	...
	var _114 = {
		render : function(_115, ul, data) {
			...
			var _116 = $(ul).prev("div.tree-node")
