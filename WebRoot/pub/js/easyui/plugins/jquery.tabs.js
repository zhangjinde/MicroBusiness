...
(function($) {
	...
	function _29(_2a) {
		...
		$(_2a).children("div.tabs-header").unbind().bind("click", function(e) {
						...
						if ($(e.target).hasClass("tabs-scroller-right")) {
							...
							if (a.length) {
								...
								if (li.length) {
									...
									if (_2f.collapsible) {
										_2f.closed ? _41(_2a, _2e) : _6b(_2a,
												_2e);
									} else {
										_41(_2a, _2e);
									}
			...
			if (li.length) {
				_2c.onContextMenu.call(_2a, e, li.find("span.tabs-title")
								.html(), _2d(li));
			}
		});
		function _2d(li) {
	...
	function _42(_43, _44) {
		...
		if (_47.tools) {
			var _4a = $("<span class=\"tabs-p-tool\"></span>").insertAfter(tab
					.find("a.tabs-inner"));
