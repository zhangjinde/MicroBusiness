/*
 * PDFObject v1.2.20111123 https://github.com/pipwerks/PDFObject Copyright (c)
 * Philip Hutchison MIT-style license: http://pipwerks.mit-license.org/
 */
...
var PDFObject = function(obj) {
	...
	id = obj.id || false, width = obj.width || "100%", height = obj.height
	...
	// Tests specifically for Adobe Reader (aka Adobe Acrobat) in non-IE
	// browsers
	hasReader = function() {
	...
	embed = function(targetID) {
		...
		if (targetID) {
			...
			targetNode = (targetID.nodeType && targetID.nodeType === 1)
					? targetID
