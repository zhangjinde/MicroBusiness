...
public class CustomerDao extends BaseDao
{
	...
	@Transactional
	public String addCustomerDetail(String busId , String openId , String name , String contactNum , String addr , String postCode) throws QryException
	{
		...
		if(jdbcTemplate.update(sql, new Object[]{busId,name,contactNum,openId}) > 0)
		{
			...
			if(jdbcTemplate.update(sql, new Object[]{name,contactNum,addr,postCode}) > 0)
			{
