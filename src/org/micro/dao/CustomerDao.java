...
public class CustomerDao extends BaseDao
{
	...
	{
		String sql = "select a.customer_telephone,a.customer_id,a.customer_name,b.customer_addr customer_addr from customer_t a,customer_address_t b where a.customer_id = b.customer_id and bus_id = ? and customer_open_id = ? and a.sts = 'A' and b.sts = 'A' and is_primary = 'A'";
		ArrayList paramList = new ArrayList();
		paramList.add(busId);
