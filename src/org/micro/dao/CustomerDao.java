...
public class CustomerDao extends BaseDao
{
	...
	@Transactional
	public String addCustomerDetail(String busId , String name , String contactNum , String provName , String cityName , String districtName , String addr , String postCode) throws QryException
	{
		...
		{
			sql = "insert into customer_address_t(customer_detail_id,customer_id,customer_addr,customer_postcode,is_primary,create_date,state_date,sts) values(MICRO_CUSM_DET_SEQ.nextval,MICRO_CUSM_SEQ.currval,?,?,'A',sysdate,sysdate,'A')";
			if(jdbcTemplate.update(sql, new Object[]{new StringBuffer().append(provName).append(cityName).append(districtName).append(addr).toString(),postCode}) > 0)
			{
