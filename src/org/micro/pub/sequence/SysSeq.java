package org.micro.pub.sequence;
...
public class SysSeq 
{
	...
	{
		Object o = jdbcTemplate.queryForObject(SqlSysDate, Timestamp.class);
	...
	{
		return getSequenceOracle(seqName, jdbcTemplate);
	}
	...
	public SysSequence getSequence(String seqName) throws Exception 
	{
		...
		List<SysSequence> seqList = jdbcTemplate.query(sequenceSql.toString(), params, new SequenceRowMapper());
	...
	{
		return jdbcTemplate.update(SysSeq.SqlSequenceUpdate, params);
	}
}
